...
<body class="xl:flex">
    ...
    <content class="xl:w-10/12 sm:w-full px-10 mt-5">
                        ...
                        <div class="grid justify-center items-center mb-3 bg-white">
                            <nav aria-label="Page navigation example w-full">
                                ...
                                <button id="nextButton"
                                    class="py-2 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Next</button>
                            </nav>
                        </div>
                    </div>
		...
		<div class="grid bg-transparent overflow-auto rounded-lg drop-shadow-md hide-show " id="attendanceSummary"
            ...
            <div>
                <table id="attendanceSummary" class="text-center w-full bg-white hover:table-fixed ">
                    <thead class="bg-gray-100 flex text-gray w-full">
                        <tr class="flex w-full even:bg-gray-100 odd:bg-white-100">
                            <th class="p-4 w-2/6" data-sort="Date">Date</th>
                ...
                <div class="grid justify-center items-center mb-3 bg-white">
                    <nav aria-label="Page navigation example w-full">
                        <button id="prevButtonAttendanceSummary"
                            class="py-2 px-3 ml-0 leading-tight text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Previous</button>
                        <button id="nextButtonAttendanceSummary"
                            class="py-2 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Next</button>
                    </nav>
                </div>
            </div>
        ...
        <div id="authentication-modal" aria-hidden="true"
            ...
            <div class="relative xl:w-2/5 sm:w-full xl:px-4 h-full md:h-auto">
                ...
                <div class="bg-white rounded-lg shadow relative dark:bg-gray-700 border-4 border-solid border-black">
                    ...
                    <form class="space-y-3 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="#">
                        <h3 class="text-2xl font-medium text-center text-gray-900 dark:text-white font-extrabold">Filing
                            Unsocial Hours</h3>
                        ...
                        <div>
                            ...
                            <input type="text" name="birthdate" id="birthdate"
                                ...
                                placeholder="(E.g 2hrs. and 30 mins)" required="">
                        </div>
                        <div>
                            <div class="flex justify-center">
                                <div class="mb-3 xl:w-full">
