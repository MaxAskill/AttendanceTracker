...
<html>
    ...
    <body>
        <header class="w-full h-20 bgcolor drop-shadow-lg sticky top-0 top-overflow-visible">
            <div class="container h-full  flex justify-between items-center">
                ...
                md:relative md:flex md:p-0 md:bg-transparent md:flex-row md:space-x-6">
                    ...
                    <li>
                        <button onClick="showSalaryMaintenance()"
                            class="bg-transparent hover:bg-white text-white font-semibold hover:text-teal-700 hover:text-opacity-50 py-2 px-4 border-2 border-white hover:border-transparent rounded focus:outline-none">Salary
                            Maintenance </button>
                        <button onClick="showDeductionMaintenance()"
                            class="bg-transparent hover:bg-white text-white font-semibold hover:text-teal-700 hover:text-opacity-50 py-2 px-4 border-2 border-white hover:border-transparent rounded focus:outline-none">Deduction
                            Maintenance</button>
                        <button onClick="showEmployeeSalary()"
                            class="bg-transparent hover:bg-white text-white font-semibold hover:text-teal-700 hover:text-opacity-50 py-2 px-4 border-2 border-white hover:border-transparent rounded focus:outline-none">Employee
                            Salary</button>
                    </li>
        ...
        <main>
            <!-- component -->
            <div id="salaryMaintenance"
                class="grid bg-white mt-5 xl:w-5/6 xl:mx-40 sm:w-full rounded-lg overflow-hidden" style="display: none">
                        ...
                        <tbody class="bg-grey-light flex flex-col text-center items-left justify-left w-full"
                            ...
                            <tr class="flex w-full even:bg-gray-100 odd:bg-white-100">
                                ...
                                <td class="p-4 w-2/6"><button
                                    ...
                                    <button
                                        class="bg-transparent hover:bg-white font-pantone font-semibold hover:text-opacity-50 py-0.5 px-2 border-2 border-pantone hover:bg-gray-200 rounded-2xl focus:outline-none">Delete</button>
                                </td>
                            </tr>
                            <tr class="flex w-full even:bg-gray-100 odd:bg-white-100">
            ...
            <div id="employeeSalary" class="grid bgcolor overflow-hidden xl:w-5/6 xl:mx-40 xl:my-12 rounded-lg mb-5"
                style="display: block">
                ...
                <div class="bg-white rounded-lg shadow relative dark:bg-gray-700">
                    ...
                    <form class="space-y-3 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="#">
                        ...
                        <div class="grid grid-cols-5 gap-1">
                            ...
                            <div class="col-start-4 col-span-1">
                                <label for="jobPosition"
                                    class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">LATE/UNDERTIME</label>
                                <input type="text" name="jobPosition" id="jobPosition"
                                    class="capitalized bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                    placeholder="Per Hour" required="" value="50.00" disabled>
                            </div>
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            ...
                            <div class="col-start-3 col-span-1">
                                <label for="jobPosition"
                                    class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Net
                                    Pay</label>
                                <input type="text" name="jobPosition" id="jobPosition"
                                    class="capitalized bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
