...
<body>
    <header class="w-full h-20 bgcolor drop-shadow-lg sticky top-0 top-overflow-visible">
        <div class="container h-full  flex justify-between items-center">
            ...
            <ul id="navmenu" class="hidden fixed top-0 right-0  bg-gray-800 z-50
                ...
                <li>
                    <button onClick="showEmployeeList()"
                    ...
                    <div class="absolute hidden xl:w-80 rounded-full group-hover:block">
                        <div
                            ...
                            <div class="content-center flex items-center justify-center mb-5"><img
                                    ...
                                    class="w-2/3 rounded-full border-white border-2 object-center" alt="Sample image" />
                            </div>
    ...
    <main>
        <!-- component -->
        <div id="employeeMasterList" class="grid bg-white mt-5 xl:w-5/6 xl:mx-40 sm:w-full rounded-lg overflow-hidden"
            style="display: block">
                ...
                <table
                    ...
                    <tbody class="bg-grey-light flex flex-col text-center items-left justify-left w-full"
                        ...
                        <tr class="flex w-full even:bg-gray-100 odd:bg-white-100">
                            ...
                            <td class="p-4 w-2/6"><a href="#attendanceSummary"><button
                                        ...
                                        onClick="showAttendance()">VIEW</button></a></td>
			...
			<button class="text-white px-1 py-1 border-2 border-white mt-2 rounded-lg">Print</button>
                    ...
                    <div class="row-start-2 row-span-2">
                        <div class="flex  float-right">
                            ...
                            <a href="#overtimeHistory"><button
                                    class="px-1 py-1 bg-white font-themecolor border-2 border-white mt-2 mr-3 rounded-lg hover:bg-transparent hover:text-white focus:outline-none"
                                    onClick="showOT()">OT History</button></a>
                            <button
                                class="px-1 py-1 bg-white font-themecolor border-2 border-white mt-2 mr-3 rounded-lg hover:bg-transparent hover:text-white focus:outline-none"
                                data-modal-toggle="print">Print</button>
                        </div>
