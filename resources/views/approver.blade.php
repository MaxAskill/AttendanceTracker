    ...
    <body class="xl:flex">
                        ...
                        <ul class="space-y-2">
                            ...
                            <li>
                                <a href="#" onClick="showSchedule()" @click="open = !open"
                                    ...
                                    <span class="flex-1 ml-3 whitespace-nowrap">Promo Schedule</span>
                                </a>
                            </li>
                            <li>
        ...
        <content class="xl:w-10/12 sm:w-full px-10 mt-5">
            ...
            <div id="schedule" class="grid bg-white sm:w-full rounded-lg overflow-hidden" style="display: none">
                <div class="grid grid-rows-2 grid-flow-col lg:px-10 sm:px-5 py-5 sm:w-full">
                    <div class="row-start-1 row-span-1 flex">
                        <h1 class="text-gray-800 text-4xl font-bold px">Promo Schedule</h1>
                        <!-- Modal toggle -->
                        <button
            ...
            <div class="grid bgcolor overflow-hidden rounded-lg py-10 px-10 my-32" id="profile" style="display:none">
                ...
                <div class="grid grid-rows-5 grid-cols-6 gap-4">
                    ...
                    <div class="row-start-1 col-span-1">
                        ...
                        <input type="text" name="mName" id="mName"
                            class="capitalized bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            placeholder="First Name" required="" value="Kapitan" disabled>
                    </div>
                    <div class="row-start-1 col-span-1">
        ...
        <div id="view-denying" aria-hidden="true"
            ...
            <div class="modal-dialog relative  sm:w-full xl:px-4 h-full md:h-auto ">
                <!-- Modal content -->
                <div
                    class="relative xl:w-1/3 ml-72 mt-24 -right-96 -bottom-12 w-full shadow-lg rounded-md bg-white border-4 border-solid border-black">
                    <div class="flex justify-end p-2">
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
        ...
        <div id="view-pending" aria-hidden="true"
            ...
            <div class="modal-dialog relative  sm:w-full xl:px-4 h-full md:h-auto ">
                <!-- Modal content -->
                <div
                    class="relative xl:w-1/3 ml-72 mt-56 -right-96 -bottom-12 w-full shadow-lg rounded-md bg-white border-4 border-solid border-black">
                    <div class="flex justify-end p-2">
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
        ...
        <div id="view-denied" aria-hidden="true"
            ...
            <div class="modal-dialog relative  sm:w-full xl:px-4 h-full md:h-auto">
                <!-- Modal content -->
                <div
                    class="relative xl:w-1/3 ml-72 mt-56 -right-96 -bottom-12 w-full shadow-lg rounded-md bg-white border-4 border-solid border-pantone">
                    <div class="flex justify-end p-2">
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
...
function deniedrenderTable() {
    ...
    denieddata.filter((row, index) => {
        ...
        deniedresult += `<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="py-6 px-6 whitespace-nowrap">${c.DeniedBy}</td>
                            <td class="py-6 px-6 whitespace-nowrap">${c.DeniedDate}</td>
