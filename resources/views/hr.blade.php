...
<html>
    ...
    <body class="xl:flex">
        ...
        <content class="xl:w-10/12 sm:w-full px-10 mt-5">
            ...
            <div class="grid bgcolor overflow-hidden rounded-lg mb-5" id="individualovertimeHistory"
                style="display:none">
                <div class="grid grid-rows-2 grid-flow-col lg:px-10 sm:px-5 py-5 sm:w-full">
                    <div class="row-start-1 row-span-1 flex">
            ...
            <div class="relative xl:w-3/5 sm:w-full xl:px-4 h-full md:h-auto">
                ...
                <div class="bg-white rounded-lg shadow relative dark:bg-gray-700">
                    ...
                    <form class="space-y-3 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="#">
                        ...
                        <div class="flex justify-center items-center w-full">
                            <label for="dropzone-file"
                                ...
                                <div class="flex flex-col justify-center items-center pt-5 pb-6">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">(xls, xlsx file only)</p>
                                </div>
                        ...
                        <button type="submit"
                            class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Upload</button>
                    </form>
                </div>
            </div>
        </div>
